...
exports.generateExamPaper = generateExamPaper;
...
async function generateExamPaper(input) {
    ...
    if (input.syllabusFile && fs_1.default.existsSync(input.syllabusFile)) {
        try {
            ...
            const fileData = fs_1.default.readFileSync(input.syllabusFile);
            reqParts.push({
                inlineData: {
    ...
    const validated = types_1.GeneratedPaperSchema.parse(parsed);
